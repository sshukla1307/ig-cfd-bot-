...
PERSONA_PROMPT = (
    ...
    "get_inventory_data on BOTH Brent and WTI to compare their individual "
    "supply/demand pictures before proposing a spread -- the thesis should be "
    "'WTI's picture is more bullish than Brent's right now' (or vice versa), "
    "not just 'oil in general seems bullish.'\n"
